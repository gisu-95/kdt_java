...
public class ArraySortTest01 {
	public static void main(String[] args) {
		...
		System.out.println("1차원 배열 값 출력 : " + Arrays.toString(number2)); // 주소값이나옴
		System.out.println("2차원 배열 값 출력 : " + Arrays.deepToString(number2));

		System.out.println("정렬 전 number : " + Arrays.toString(number));
		Arrays.sort(number); // number (1차원)배열 오름차순 정렬
...
//		2차원 배열의 내부요소 정렬은 for문이나 수동정렬이 필요하다!!
//		방법1.for문 이용
