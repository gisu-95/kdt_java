...
public class Variable02 { //클래스 중괄호 영역 시작
	public static void main(String[] args) { //main 메소드 중괄호영역 시작
		...
		System.out.println(num1 + num2 + num3); //정수형은 덧셈연산결과 학인이 가능하다

		int num4 = 10, num5 = 20 , num6 = 30;
		//정수형 변수 num4에 10이라는 정수형값을 저장, num5에 20이라는 정수형값을 저장, num6에 30이라는 정수형값을 저장
		//여러개의 변수를 선언시 같은 타입이라면 ,를 이용해서 여러개 선언할 수 있다
