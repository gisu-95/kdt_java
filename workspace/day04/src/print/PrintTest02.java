...
//		String name = "김기수";
//		int age = 20;
//		System.out.println("제 이름은 김기수이고, 나이는 20살 입니다.");
...
//		System.out.printf("제 이름은 %s이고, 나이는 %d살 입니다.", name, age);
		...
		//실수형
		System.out.printf("\n실수형 : %f\n", 3.1234567);
		//float 타입 => 소수점 이하 6자리까지 정확하게 나옴, 7자리 이상이면 7번째 자리에서 반올림
		System.out.printf("\n실수형 2자리까지 표현 : %.2f\n", 3.12345);		
//		double num2	= 3.123456789123456; // double 타입은 소수점이하 15자리까지 정확하게 나옴
